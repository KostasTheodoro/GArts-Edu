...
export default function HowWeThink() {
  ...
  return (
    <div className="w-full py-16 px-4">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center bg-neural-dark rounded-2xl p-8 md:p-12">
        <div className="relative w-full aspect-square max-w-2xl mx-auto">
          ...
          {circles.map((circle) => {
            const position = getCirclePosition(circle.centerX, circle.centerY);
            return (
              <div
                key={circle.id}
          ...
          {circles.map((circle) => {
            ...
            return (
              ...
              >
                <span
                  className={`text-lg font-semibold transition-all duration-300 whitespace-nowrap ${
                    isActive
