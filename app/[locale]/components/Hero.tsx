...
export default function HeroBlended() {
  ...
  return (
    <section className="relative min-h-[70vh] sm:min-h-screen lg:min-h-[80vh] flex flex-col justify-between pt-8 sm:pt-16 pb-4 sm:pb-40 overflow-hidden">
      {/* Mobile & Tablet Video */}
      <video
        autoPlay
        loop
      ...
      <div className="relative z-10 text-center px-4">
        <h1 className="text-4xl   sm:text-6xl lg:text-7xl font-bold text-white tracking-widest md:tracking-[0.25em] [text-shadow:0_0_20px_rgba(255,255,255,0.8),0_0_40px_rgba(255,255,255,0.5)]">
          {t("hero.title")}
        </h1>
      </div>
